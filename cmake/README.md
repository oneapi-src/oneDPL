...
| ONEDPL_AOT_TARGETS           | STRING | Device target options for ahead-of-time compilation, supported values can be found [here](https://intel.github.io/llvm-docs/UsersManual.html)                                                                                            | "spir64_gen" for GPU device and "spir64_x86_64" for CPU device |
| ONEDPL_AOT_ARCH              | STRING | Architecture options for ahead-of-time compilation, supported values can be found [here](https://software.intel.com/content/www/us/en/develop/documentation/oneapi-dpcpp-cpp-compiler-dev-guide-and-reference/top/compilation/ahead-of-time-compilation.html)                                                                                            | "*" for GPU device and "avx" for CPU device only if ONEDPL_AOT_TARGETS is unspecified |
