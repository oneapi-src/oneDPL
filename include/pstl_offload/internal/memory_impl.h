...
{
    return oneapi::dpl::uninitialized_copy(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last, __result);
}
...
{
    return oneapi::dpl::uninitialized_copy_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n, __result);
}
...
_ForwardIterator uninitialized_move(const execution::parallel_unsequenced_policy&, _InputIterator __first, _InputIterator __last,
                                    _ForwardIterator __result)
{
    return oneapi::dpl::uninitialized_move(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last, __result);
}
...
{
    return oneapi::dpl::uninitialized_move_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n, __result);
}
...
{
    oneapi::dpl::uninitialized_fill(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last, __value);
}
...
{
    return oneapi::dpl::uninitialized_fill_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n, __value);
}

template <class _ForwardIterator>
void destroy(const execution::parallel_unsequenced_policy&, _ForwardIterator __first, _ForwardIterator __last)
{
    oneapi::dpl::destroy(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last);
}

template <class _ForwardIterator, class _Size>
void destroy_n(const execution::parallel_unsequenced_policy&, _ForwardIterator __first, _Size __n)
{
    oneapi::dpl::destroy_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n);
}
...
{
    oneapi::dpl::uninitialized_default_construct(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last);
}

template <class _ForwardIterator, class _Size>
void uninitialized_default_construct_n(const execution::parallel_unsequenced_policy&, _ForwardIterator __first, _Size __n)
{
    oneapi::dpl::uninitialized_default_construct_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n);
}
...
{
    oneapi::dpl::uninitialized_value_construct(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __last);
}

template <class _ForwardIterator, class _Size>
void uninitialized_value_construct_n(const execution::parallel_unsequenced_policy&, _ForwardIterator __first, _Size __n)
{
    oneapi::dpl::uninitialized_value_construct_n(oneapi::dpl::pstl_offload::offload_policy_holder.get_policy(), __first, __n);
}
