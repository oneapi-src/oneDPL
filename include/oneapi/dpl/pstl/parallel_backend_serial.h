...
// The definition of _ONEDPL_PARALLEL_BACKEND_SERIAL_H means the inclusion of this
// file and therefore the parallel serial backend. Be careful when changing the value
