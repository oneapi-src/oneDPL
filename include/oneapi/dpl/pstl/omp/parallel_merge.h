...
void
__parallel_merge_body(std::size_t __size_x, std::size_t __size_y, _RandomAccessIterator1 __xs, _RandomAccessIterator1 __xe,
   ...
   /* if (__size_y > __size_x) {
    ...
    __chunk_partitioner(__ys, __ye, __n_chunks, __chunk_size, __first_chunk_size,
