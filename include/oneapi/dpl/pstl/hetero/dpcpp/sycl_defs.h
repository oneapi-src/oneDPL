...
#    define _ONEDPL_DPCPP_LIBSYCL_VERSION                                                                              \
        (__LIBSYCL_MAJOR_VERSION * 10000 + __LIBSYCL_MINOR_VERSION * 100 + __LIBSYCL_PATCH_VERSION)
#else
#    define _ONEDPL_DPCPP_LIBSYCL_VERSION 0
#endif
#define _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(_ONEDPL_LIBSYCL_VERSION)                                                      \
    (_ONEDPL_DPCPP_LIBSYCL_VERSION >= _ONEDPL_LIBSYCL_VERSION || _ONEDPL_DPCPP_LIBSYCL_VERSION == 0)

#if _ONEDPL_FPGA_DEVICE
#    if _ONEDPL_DPCPP_LIBSYCL_VERSION >= 50400
...
#define _ONEDPL_SYCL2020_NO_INIT_PRESENT _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(50300)
#define _ONEDPL_SYCL2020_KERNEL_BUNDLE_PRESENT _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(50300)
#define _ONEDPL_SYCL2020_COLLECTIVES_PRESENT _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(50300)
...
#define _ONEDPL_SYCL2020_SUB_GROUP_PRESENT _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(50700)
...
#elif _ONEDPL_DPCPP_LIBSYCL_VERSION == 50200
template <typename _BinaryOp, typename _T>
...
{
#if 0 //_ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(50300)
...
#if _ONEDPL_FPGA_DEVICE
#    if _ONEDPL_DPCPP_LIBSYCL_VERSION >= 60100
...
#    elif _ONEDPL_DPCPP_LIBSYCL_VERSION >= 50300
inline auto __fpga_emulator_selector()
{
...
{
#if _ONEDPL_DPCPP_LIBSYCL_ZERO_OR_GE(70000)
