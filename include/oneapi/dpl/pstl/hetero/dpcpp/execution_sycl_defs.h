...
using __enable_if_device_execution_policy_single_no_default = ::std::enable_if_t<
...
using __enable_if_device_execution_policy_double_no_default = ::std::enable_if_t<
    oneapi::dpl::__internal::__is_device_execution_policy<typename ::std::decay_t<_ExecPolicy>>::value &&
