...
class all_view
{
  ...
  public:
    all_view(sycl::buffer<_T, 1> __buf = sycl::buffer<_T, 1>(0), diff_type __offset = 0, diff_type __n = 0)
        : m_acc(__buf, sycl::range<1>(__n > 0 ? __n : __sycl::__get_buffer_size(__buf)), __offset)
    {
    }
    ...
    size() const
    {
        return __sycl::__get_accessor_size(m_acc);
    }
    bool
    empty() const
    {
...
struct __get_sycl_range
{
  ...
  public:
        ...
        typename ::std::enable_if<
            ...
            __range_holder<oneapi::dpl::__ranges::permutation_view_simple<
                decltype(::std::declval<__get_sycl_range<AccMode, _Iterator>>()(
                             __first.base(), __first.base() + __sycl::__get_buffer_size(__first.base().get_buffer()))
                             .all_view()),
            ...
            type
    {
        ...
        auto res_src =
            this->operator()(__first.base(), __first.base() + __sycl::__get_buffer_size(__first.base().get_buffer()));
