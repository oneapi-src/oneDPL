                      ...
                      _Proj __proj, bool& __sorted)
{
    ...
    if (__n <= 64 && __wg_size <= __max_wg_size
        ...
        || __n <= 256 && __wg_size * 2 <= __max_wg_size
        || __n <= 512 && __wg_size * 2 <= __max_wg_size
        || __n <= 1024 && __wg_size * 2 <= __max_wg_size
        || __n <= 2048 && __wg_size * 4 <= __max_wg_size
        || __n <= 4096 && __wg_size * 4 <= __max_wg_size
        || __n <= 8192 && __wg_size * 8 <= __max_wg_size && __dev_has_sg16
        || __n <= 16384 && __wg_size * 8 <= __max_wg_size && __dev_has_sg16)
    {
        // Do not use radix sort for one work-group, simple return
        __sorted = false;
    }
    else
    {
