...
struct __parallel_radix_sort_iteration
{
           ...
           _OutRange&& __out_rng, _TmpBuf& __tmp_buf, sycl::event __dependency_event, _Proj __proj)
    {
        ...
        using _RadixCountKernel =
            __internal::__kernel_name_generator<__count_phase, _CustomName, _ExecutionPolicy, ::std::decay_t<_InRange>,     // KSATODO: __kernel_name_generator with _ExecutionPolicy - __parallel_radix_sort_iteration: should we still use _ExecutionPolicy here and below?
                                                ::std::decay_t<_TmpBuf>, _Proj>;
        using _RadixLocalScanKernel = __internal::__kernel_name_generator<__local_scan_phase, _CustomName,                  // KSATODO: __kernel_name_generator with _ExecutionPolicy - __parallel_radix_sort_iteration: should we still use _ExecutionPolicy here and below?
                                                                          _ExecutionPolicy, ::std::decay_t<_TmpBuf>>;
        using _RadixReorderPeerKernel =
            __internal::__kernel_name_generator<__reorder_peer_phase, _CustomName, _ExecutionPolicy,                        // KSATODO: __kernel_name_generator with _ExecutionPolicy - __parallel_radix_sort_iteration: should we still use _ExecutionPolicy here and below?
                                                ::std::decay_t<_InRange>, ::std::decay_t<_OutRange>, _Proj>;
        using _RadixReorderKernel =
            __internal::__kernel_name_generator<__reorder_phase, _CustomName, _ExecutionPolicy,                             // KSATODO: __kernel_name_generator with _ExecutionPolicy - __parallel_radix_sort_iteration: should we still use _ExecutionPolicy here and below?
                                                ::std::decay_t<_InRange>, ::std::decay_t<_OutRange>, _Proj>;
