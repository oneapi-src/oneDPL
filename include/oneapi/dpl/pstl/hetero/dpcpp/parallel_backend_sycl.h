                     ...
                     _CopyByMaskOp __copy_by_mask_op)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<oneapi::dpl::__internal::__device_backend_tag, _ExecutionPolicy,
                                                int32_t>
        __mask_buf(oneapi::dpl::__internal::__device_backend_tag{}, __exec, __n);
                                 ...
                                 __internal::__optional_kernel_name<_CopyBackName...>>
{
    ...
    operator()(_ExecutionPolicy&& __exec, _Range&& __rng, _Compare __comp) const
    {
        ...
        // 2. Merge sorting
        oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, _Tp> __temp_buf(_BackendTag{},
                                                                                                   __exec, __n);
                                         ...
                                         __internal::__optional_kernel_name<_CopyBackName...>>
{
    ...
    operator()(_ExecutionPolicy&& __exec, _Range&& __rng, _Merge __merge, _Compare __comp) const
    {
        ...
        oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, _Tp> __temp_buf(_BackendTag{}, __exec,
                                                                                                 __n);
        auto __temp = __temp_buf.get_buffer();
        _PRINT_INFO_IN_DEBUG_MODE(__exec);
