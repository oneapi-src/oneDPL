...
auto
__parallel_histogram(oneapi::dpl::__internal::__fpga_backend_tag, _ExecutionPolicy&& __exec,
                     ...
                     _Range1&& __input, _Range2&& __bins, const _BinHashMgr& __binhash_manager)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__parallel_histogram(
        oneapi::dpl::__internal::__device_backend_tag{}, __exec.__device_policy(), __init_event,
