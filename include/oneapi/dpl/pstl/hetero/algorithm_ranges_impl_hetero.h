...
__pattern_swap(_ExecutionPolicy&& __exec, _Range1&& __rng1, _Range2&& __rng2, _Function __f)
{
    ...
    {
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(__exec.__make_wrapped_policy<__swap1_wrapper>(), __f,
                                                            __rng1, __rng2);
        return __rng1.size();
    }

    oneapi::dpl::__internal::__ranges::__pattern_walk_n(__exec.__make_wrapped_policy<__swap2_wrapper>(), __f, __rng2,
                                                        __rng1);
    return __rng2.size();
}
...
__pattern_find_if(_ExecutionPolicy&& __exec, _Range&& __rng, _Pred __pred)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__parallel_find_or(
        __exec.__make_wrapped_policy<__par_backend_hetero::__find_policy_wrapper>(), _Predicate{__pred}, _TagType{},
...
__pattern_any_of(_ExecutionPolicy&& __exec, _Range&& __rng, _Pred __pred)
{
    ...
    using _Predicate = oneapi::dpl::unseq_backend::single_match_pred<_ExecutionPolicy, _Pred>;
    return oneapi::dpl::__par_backend_hetero::__parallel_find_or(
        __exec.__make_wrapped_policy<oneapi::dpl::__par_backend_hetero::__or_policy_wrapper>(), _Predicate{__pred},
        oneapi::dpl::__par_backend_hetero::__parallel_or_tag{}, ::std::forward<_Range>(__rng));
}
...
__pattern_search(_ExecutionPolicy&& __exec, _Range1&& __rng1, _Range2&& __rng2, _Pred __pred)
{
    ...
    if (__rng1.size() == __rng2.size())
    {
        const bool __res = __pattern_equal(__exec.__make_wrapped_policy<equal_wrapper>(), __rng1,
                                           ::std::forward<_Range2>(__rng2), __pred);
        return __res ? 0 : __rng1.size();
    }
    ...
    return oneapi::dpl::__par_backend_hetero::__parallel_find_or(
        __exec.__make_wrapped_policy<oneapi::dpl::__par_backend_hetero::__find_policy_wrapper>(), _Predicate{__pred},
        _TagType{}, ::std::forward<_Range1>(__rng1), ::std::forward<_Range2>(__rng2));
}
...
__pattern_merge(_ExecutionPolicy&& __exec, _Range1&& __rng1, _Range2&& __rng2, _Range3&& __rng3, _Compare __comp)
{
    ...
    if (__n1 == 0)
    {
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(
            __exec.__make_wrapped_policy<__copy1_wrapper>(), oneapi::dpl::__internal::__brick_copy<_ExecutionPolicy>{},
            ::std::forward<_Range2>(__rng2), ::std::forward<_Range3>(__rng3));
    }
    else if (__n2 == 0)
    {
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(
            __exec.__make_wrapped_policy<__copy2_wrapper>(), oneapi::dpl::__internal::__brick_copy<_ExecutionPolicy>{},
                            ...
                            _Range4&& __out_values, _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    if (__n == 1)
    {
        ...
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(__exec.__make_wrapped_policy<__copy_keys_wrapper>(),
                                                            __copy_range, ::std::forward<_Range1>(__keys),
                                                            ::std::forward<_Range3>(__out_keys));

        oneapi::dpl::__internal::__ranges::__pattern_walk_n(__exec.__make_wrapped_policy<__copy_values_wrapper>(),
                                                            __copy_range, ::std::forward<_Range2>(__values),
    ...
    auto __intermediate_result_end = __pattern_copy_if(
        __exec.__make_wrapped_policy<__assign_key1_wrapper>(), __view1, __view2,
    ...
    oneapi::dpl::__par_backend_hetero::__parallel_for(
        __exec.__make_wrapped_policy<__reduce1_wrapper>(),
    ...
    auto __result_end = __pattern_copy_if(
        __exec.__make_wrapped_policy<__assign_key2_wrapper>(), __view3, __view4,
    ...
    //reduce by segment
    oneapi::dpl::__par_backend_hetero::__parallel_for(
        __exec.__make_wrapped_policy<__reduce2_wrapper>(),
