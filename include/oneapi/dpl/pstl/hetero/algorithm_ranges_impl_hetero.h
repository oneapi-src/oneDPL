                    ...
                    _CreateMaskOp __create_mask_op, _CopyByMaskOp __copy_by_mask_op)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, int32_t> __mask_buf(
        _BackendTag{}, __exec, __rng1.size());
                            ...
                            _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    auto __idx = oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, __diff_type>(_BackendTag{},
                                                                                                         __exec, __n)
                     .get_buffer();
    auto __tmp_out_keys = oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, __key_type>(
                              _BackendTag{}, __exec, __n)
                              .get_buffer();
    auto __tmp_out_values = oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, _ExecutionPolicy, __val_type>(
                                _BackendTag{}, __exec, __n)
                                .get_buffer();
