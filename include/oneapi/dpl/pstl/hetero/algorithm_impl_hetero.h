                ...
                _Function __f)
{
    ...
    oneapi::dpl::__par_backend_hetero::__parallel_for<__par_backend_hetero::__deferrable_mode>(
                ...
                _Iterator2 __first2, _Iterator2 __last2, _Iterator3 __d_first, _Compare __comp)
{
    ...
    else
    {
        ...
        __par_backend_hetero::__parallel_merge<__par_backend_hetero::__deferrable_mode>(
                              ...
                              _Compare __comp, _Proj __proj)
{
    ...
    __par_backend_hetero::__parallel_stable_sort<__par_backend_hetero::__deferrable_mode>(
                       ...
                       _Iterator __last, _Compare __comp)
{
    ...
    __par_backend_hetero::__parallel_partial_sort<__par_backend_hetero::__deferrable_mode>(
        _BackendTag{}, ::std::forward<_ExecutionPolicy>(__exec),
                            ...
                            _InIterator __last, _OutIterator __out_first, _OutIterator __out_last, _Compare __comp)
{
    ...
    else
    {
        ...
        auto __buf_last = __pattern_walk2<__par_backend_hetero::__sync_mode>(
