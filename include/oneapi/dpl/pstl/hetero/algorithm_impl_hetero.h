...
template <typename _BackendTag, __par_backend_hetero::access_mode __acc_mode1 = __par_backend_hetero::access_mode::read,
          ...
          typename _Function>
_ForwardIterator3
__pattern_walk3(__hetero_tag<_BackendTag> __tag, _ExecutionPolicy&& __exec, _ForwardIterator1 __first1,
                _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator3 __first3, _Function __f)
{
    ...
    __pattern_walk3_async<_BackendTag, __acc_mode1, __acc_mode2, __acc_mode3>(
               __tag, std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __first3, __f)
        .__deferrable_wait();
...
{
    return __pattern_fill_async(__tag, std::forward<_ExecutionPolicy>(__exec), __first, __last, __value).get();
}
