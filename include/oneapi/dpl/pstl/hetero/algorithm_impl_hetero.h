                ...
                _ForwardIterator1 __last1, _ForwardIterator2 __first2, _Function __f)
{
    ...
    auto __future = oneapi::dpl::__internal::__except_handler([&]() {
                 ...
                 _Iterator __last)
{
    ...
    oneapi::dpl::__internal::__except_handler([&]() {
        oneapi::dpl::__par_backend_hetero::__parallel_for(
            ...
            unseq_backend::__rotate_copy<typename ::std::iterator_traits<_Iterator>::difference_type>{__n, __shift},
        ...
        auto __temp_rng_rw = oneapi::dpl::__ranges::all_view<_Tp, __par_backend_hetero::access_mode::read_write>(
