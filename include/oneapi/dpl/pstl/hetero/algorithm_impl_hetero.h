                ...
                _ForwardIterator2 __first2, _Function __f, /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    oneapi::dpl::__par_backend_hetero::__ranges::__parallel_for(::std::forward<_ExecutionPolicy>(__exec),
...
{
    return __pattern_walk2<__par_backend_hetero::read_write, __par_backend_hetero::read_write>(
        ::std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __f, ::std::true_type(),
        ::std::true_type());
}
                      ...
                      /*vector*/ ::std::true_type, /*parallel*/ ::std::true_type)
{
    ...
    auto __keep = oneapi::dpl::__ranges::__get_sycl_range<cl::sycl::access::mode::read, _Iterator>();
    auto __buf = __keep(__first, __last);
                    ...
                    _CreateMaskOp __create_mask_op, _CopyByMaskOp __copy_by_mask_op)
{
    ...
    auto __res = __parallel_transform_scan(
        ::std::forward<_ExecutionPolicy>(__exec),
                    ...
                    /*vector*/ ::std::true_type, /*parallel*/ ::std::true_type)
{
    ...
    return __pattern_walk2(make_wrapped_policy<copy_back_wrapper>(::std::forward<_ExecutionPolicy>(__exec)),
                           __copy_first, __copy_last, __first, __brick_copy<_ExecutionPolicy>{}, ::std::true_type{},
                           ::std::true_type{});
}
                 ...
                 /*vector*/ ::std::true_type, /*parallel*/ ::std::true_type)
{
    ...
    //TODO: optimize copy back depending on Iterator, i.e. set_final_data for host iterator/pointer
    return __pattern_walk2<__par_backend_hetero::read_write, __par_backend_hetero::read_write>(
        make_wrapped_policy<copy_back_wrapper>(::std::forward<_ExecutionPolicy>(__exec)), __copy_first, __copy_last,
        __first, __brick_copy<_ExecutionPolicy>{}, ::std::true_type{}, ::std::true_type{});
}
...
struct acc_handler_lexicographical_compare
{
    ...
    _ReduceValueType
    operator()(_GlobalIdx __gidx, _Acc1 __acc1, _Acc2 __acc2)
    {
                                  ...
                                  /*parallel*/ ::std::true_type)
{
    ...
    auto __keep1 = oneapi::dpl::__ranges::__get_sycl_range<cl::sycl::access::mode::read, _Iterator1>();
    auto __buf1 = __keep1(__first1, __first1 + __shared_size);

    auto __keep2 = oneapi::dpl::__ranges::__get_sycl_range<cl::sycl::access::mode::read, _Iterator2>();
                   ...
                   /*parallel=*/::std::true_type)
{
    ...
    return !__par_backend_hetero::__parallel_or(::std::forward<_ExecutionPolicy>(__exec),
                                                make_iter_mode<read>(__first2), make_iter_mode<read>(__last2),
                                                make_iter_mode<read>(__first1), make_iter_mode<read>(__last1),
                            ...
                            /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    if (__in_size <= __out_size)
    {
        ...
        auto __out_end = __pattern_walk2(
            make_wrapped_policy<__initial_copy_1>(::std::forward<_ExecutionPolicy>(__exec)), __first, __last,
            __out_first, __brick_copy<_ExecutionPolicy>{}, ::std::true_type{}, ::std::true_type{});
    ...
    else
    {
        ...
        auto __buf_last = __pattern_walk2(
            make_wrapped_policy<__initial_copy_2>(::std::forward<_ExecutionPolicy>(__exec)), __first, __last,
            __buf_first, __brick_copy<_ExecutionPolicy>{}, ::std::true_type{}, ::std::true_type{});
                 ...
                 /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    oneapi::dpl::__par_backend_hetero::__ranges::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __brick, __n,
                        ...
                        _Compare __comp, _IsOpDifference)
{
    ...
    _Assigner __assign_op;
    _DataAcc __get_data_op;
    __get_mask<_Size1, 2> __get_mask_op;
