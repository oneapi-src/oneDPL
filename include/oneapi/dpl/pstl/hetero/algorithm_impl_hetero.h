               ...
               _ForwardIterator2 __first2, _Function __f, /*is_vector=*/std::true_type, /*is_parallel=*/std::true_type)
{
    return __pattern_walk2<__par_backend_hetero::read_write, __par_backend_hetero::read_write>(
        std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __f, std::true_type(), std::true_type());
}
...
__pattern_adjacent_find(_ExecutionPolicy&& __exec, _Iterator __first, _Iterator __last, _BinaryPredicate __predicate,
                        /*parallel*/ std::true_type, /*vector*/ std::true_type, oneapi::dpl::__internal::__or_semantic)
{
    if (__first == __last)
        return __last;
...
__pattern_equal(_ExecutionPolicy&& __exec, _Iterator1 __first1, _Iterator1 __last1, _Iterator2 __first2, _Pred __pred,
                /*vector=*/std::true_type, /*parallel=*/std::true_type)
{
    return oneapi::dpl::__internal::__pattern_equal(std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2,
                  ...
                  _Predicate __pred, /*vector=*/std::true_type, /*parallel=*/std::true_type)
{
    ...
    unseq_backend::__copy_by_mask<_ReduceOp, oneapi::dpl::__internal::__no_op, /*inclusive*/ std::true_type, 1>
        __copy_by_mask_op;
                         ...
                         /*parallel*/ std::true_type)
{
    ...
    unseq_backend::__partition_by_mask<_ReduceOp, oneapi::dpl::__internal::__no_op, /*inclusive*/ std::true_type>
        __copy_by_mask_op{_ReduceOp{}};
...
{
    using _It1DifferenceType = typename std::iterator_traits<_Iterator1>::difference_type;
    unseq_backend::__copy_by_mask<std::plus<_It1DifferenceType>, oneapi::dpl::__internal::__no_op,
                        ...
                        _Compare __comp, _IsOpDifference)
{
    ...
    unseq_backend::__copy_by_mask<_ReduceOp, oneapi::dpl::__internal::__no_op, /*inclusive*/ std::true_type, 2>
        __copy_by_mask_op;
    ...
    auto __result_size =
        __parallel_transform_scan(
            ...
            __result, __reduce_op, _InitType{},
            // local scan
            unseq_backend::__scan</*inclusive*/ std::true_type, _ExecutionPolicy, _ReduceOp, _DataAcc, _Assigner,
