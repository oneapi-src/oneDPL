                    ...
                    _Predicate __pred)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __buf(_BackendTag{}, __last - __first);
                        ...
                        _Iterator __middle, _Iterator __last, _Compare __comp)
{
    ...
    auto __n = __last - __first;
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __buf(_BackendTag{}, __n);
    auto __copy_first = __buf.get();
                           ...
                           _Iterator __last, _UnaryPredicate __pred)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __true_buf(_BackendTag{}, __n);
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __false_buf(_BackendTag{}, __n);
                            ...
                            _InIterator __last, _OutIterator __out_first, _OutIterator __out_last, _Compare __comp)
{
    ...
    else
    {
        ...
        oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __buf(_BackendTag{}, __in_size);
                 ...
                 _Iterator __last)
{
    ...
    auto __keep = oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read_write, _Iterator>();
    auto __buf = __keep(__first, __last);
    auto __temp_buf = oneapi::dpl::__par_backend_hetero::__buffer<_Tp>(_BackendTag{}, __n);
                        ...
                        _OutputIterator __result, _Compare __comp, _IsOpDifference)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<int32_t> __mask_buf(_BackendTag{}, __n1);
                    ...
                    _OutputIterator __result, _Compare __comp)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __diff(_BackendTag{}, __n2);
                                   ...
                                   _ForwardIterator2 __last2, _OutputIterator __result, _Compare __comp)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __diff_1(_BackendTag{}, __n1);
    auto __buf_1 = __diff_1.get();
    const auto __n2 = __last2 - __first2;
    oneapi::dpl::__par_backend_hetero::__buffer<_ValueType> __diff_2(_BackendTag{}, __n2);
