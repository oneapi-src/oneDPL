                        ...
                        _BinaryPredicate __predicate, oneapi::dpl::__internal::__or_semantic)
{
    ...
    bool result = __par_backend_hetero::__parallel_find_or(     // to __pattern_transform_reduce - not required due bad performance + optimized inside __parallel_find_or for __parallel_or_tag
        _BackendTag{}, ::std::forward<_ExecutionPolicy>(__exec),
                   ...
                   _Iterator2 __first2, _Iterator2 __last2, _Pred __pred)
{
    ...
    auto __result = __par_backend_hetero::__parallel_find(     // to __pattern_transform_reduce - not required due bad performance
