...
{
    return ::std::experimental::parallelism_v2::reduction(__var, __var, oneapi::dpl::__internal::__pstl_min{});
}
...
{
    return ::std::experimental::parallelism_v2::reduction(__var, __var, oneapi::dpl::__internal::__pstl_max{});
}
