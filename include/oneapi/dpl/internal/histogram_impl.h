...
template <typename _ExecutionPolicy, typename _Iter1, typename _Iter2, typename _Size, typename _IdxHashFunc, typename... _Range>
inline void
__pattern_histogram(_ExecutionPolicy&& exec, _Iter1 __first, _Iter1 __last, _Iter2 __histogram_first, const _Size& num_bins,
...
template <typename _ExecutionPolicy, typename Iter1, typename OutputIter, typename _Size, typename _T>
oneapi::dpl::__internal::__enable_if_hetero_execution_policy<typename ::std::decay<_ExecutionPolicy>::type>
__histogram_impl(_ExecutionPolicy&& exec, Iter1 __first, Iter1 __last, OutputIter __histogram_first, const _Size& num_bins,
                 const _T& __first_bin_min_val, const _T& __last_bin_max_val)
{
    __internal::__pattern_histogram(
        ::std::forward<_ExecutionPolicy>(exec), __first, __last, __histogram_first, num_bins,
        __internal::__evenly_divided_binhash<_T>(__first_bin_min_val, __last_bin_max_val, num_bins));
}

template <typename _ExecutionPolicy, typename Iter1, typename OutputIter, typename Iter3>
oneapi::dpl::__internal::__enable_if_hetero_execution_policy<typename ::std::decay<_ExecutionPolicy>::type>
__histogram_impl(_ExecutionPolicy&& exec, Iter1 __first, Iter1 __last, OutputIter __histogram_first, Iter3 __boundary_first,
...
histogram(_ExecutionPolicy&& exec, _RandomAccessIterator1 __first, _RandomAccessIterator1 __last, const _Size& __num_bins,
...
histogram(_ExecutionPolicy&& exec, _RandomAccessIterator1 __first, _RandomAccessIterator1 __last, _RandomAccessIterator2 __boundary_first,
