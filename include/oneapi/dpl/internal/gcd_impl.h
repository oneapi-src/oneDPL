...
// gcd
// Usually std::gcd and std::lcm implemented in STL as recursive function.
// SYCL doesn't support recursive call in a kernel.
// For more details about C++ limitations see the SYCL specification.
