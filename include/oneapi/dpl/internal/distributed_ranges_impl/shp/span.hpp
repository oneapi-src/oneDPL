...
class span : public stdrng::view_interface<span<T, Iter>>
{
  public:
    ...
    span(R&& r) : begin_(stdrng::begin(r)), end_(stdrng::end(r))
    {
    }
...
template <stdrng::random_access_range R>
span(R&&) -> span<stdrng::range_value_t<R>, stdrng::iterator_t<R>>;
