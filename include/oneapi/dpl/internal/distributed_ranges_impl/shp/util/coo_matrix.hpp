...
public:
  ...
  using reference = experimental::dr::shp::matrix_ref<T, I>;
  using const_reference = experimental::dr::shp::matrix_ref<std::add_const_t<T>, I>;

  using scalar_reference = T &;

  coo_matrix(experimental::dr::index<I> shape) : shape_(shape) {}

  experimental::dr::index<I> shape() const noexcept { return shape_; }
  ...
  void reshape(experimental::dr::index<I> shape) {
...
private:
  experimental::dr::index<I> shape_;
