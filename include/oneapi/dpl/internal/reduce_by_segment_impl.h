                       ...
                       BinaryOperator binary_op)
{
    ...
    {
        auto first2_acc = internal::get_access<cl::sycl::access::mode::read>(policy, first2);
    ...
    {
        auto result1_acc = internal::get_access<cl::sycl::access::mode::write>(policy, result1);
        auto result2_acc = internal::get_access<cl::sycl::access::mode::write>(policy, result2);
        auto first1_acc = internal::get_access<cl::sycl::access::mode::read>(policy, first1);
