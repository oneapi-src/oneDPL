                                  ...
                                  Operator binary_op)
{
    ...
    // compute head flags
    oneapi::dpl::__par_backend::__buffer<__backend_tag, Policy, FlagType> _flags(__backend_tag{}, policy, n);
    ...
    oneapi::dpl::__par_backend::__buffer<__backend_tag, Policy, OutputType> _temp(__backend_tag{}, policy, n);
    auto temp = _temp.get();
                               ...
                               ::std::false_type /* has_known_identity*/)
{
    ...
    // compute head flags
    oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, Policy, FlagType> _flags(_BackendTag{}, policy, n);
    {
    ...
    // shift input one to the right and initialize segments with init
    oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, Policy, OutputType> _temp(_BackendTag{}, policy, n);
    {
