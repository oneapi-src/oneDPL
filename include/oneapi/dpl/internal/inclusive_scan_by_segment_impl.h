                                  ...
                                  BinaryOperator binary_op)
{
    ...
    oneapi::dpl::__par_backend::__buffer<__backend_tag, Policy, FlagType> _mask(__backend_tag{}, policy, n);
    auto mask = _mask.get();
                               ...
                               ::std::false_type /* has_known_identity */)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_BackendTag, Policy, FlagType> _mask(_BackendTag{}, policy, n);
    {
