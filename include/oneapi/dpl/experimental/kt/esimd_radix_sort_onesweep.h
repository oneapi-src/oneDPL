...
global_histogram(sycl::nd_item<1> idx, size_t __n, const InputT& input, uint32_t* p_global_offset)
{
    ...
    constexpr constexpr uint32_t MAX_STAGES_PER_BLOCK = 8;
    constexpr uint32_t STAGES_PER_BLOCK = sizeof(_KeyT) < MAX_STAGES_PER_BLOCK ? sizeof(_KeyT) : MAX_STAGES_PER_BLOCK;
