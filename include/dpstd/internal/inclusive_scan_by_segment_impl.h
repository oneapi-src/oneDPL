...
namespace internal {
    ...
    dpstd::__internal::__enable_if_host_execution_policy<typename std::decay<Policy>::type, OutputIterator>
    inclusive_scan_by_segment_impl(Policy&& policy, InputIterator1 first1, InputIterator1 last1,
                                   ...
                                   BinaryOperator binary_op)
    {
        ...
        dpstd::__par_backend::__buffer<policy_type, FlagType> _mask(n);
        auto mask = _mask.get();
    ...
    template<typename Policy, typename InputIterator1, typename InputIterator2,
             typename OutputIterator, typename BinaryPredicate, typename BinaryOperator>
    dpstd::__internal::__enable_if_hetero_execution_policy<typename std::decay<Policy>::type, OutputIterator>
    inclusive_scan_by_segment_impl(Policy&& policy, InputIterator1 first1, InputIterator1 last1,
                                   InputIterator2 first2, OutputIterator result, BinaryPredicate binary_pred,
                                   BinaryOperator binary_op)
    {
        ...
        transform_inclusive_scan(policy1,
                       ...
                       dpstd::__par_backend_hetero::__internal::make_tuple(initial_value, initial_mask)
        );
    ...
    inclusive_scan_by_segment(Policy&& policy, InputIterator1 first1, InputIterator1 last1,
                              ...
                              BinaryOperator binary_op)
    {
        return internal::inclusive_scan_by_segment_impl(std::forward<Policy>(policy), first1, last1,
    ...
    dpstd::__internal::__enable_if_execution_policy<Policy, OutputIter>
    inclusive_scan_by_segment(Policy&& policy, InputIter1 first1, InputIter1 last1, InputIter2 first2,
                              OutputIter result, BinaryPredicate binary_pred)
    {
    ...
    template<typename Policy, typename InputIter1, typename InputIter2, typename OutputIter,
             typename BinaryPredicate>
    dpstd::__internal::__enable_if_execution_policy<Policy, OutputIter>
    inclusive_scan_by_key(Policy&& policy, InputIter1 first1, InputIter1 last1, InputIter2 first2,
                          OutputIter result, BinaryPredicate binary_pred)
    {
        using T = typename std::iterator_traits<InputIter2>::value_type;
