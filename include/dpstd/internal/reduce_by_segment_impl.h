                       ...
                       BinaryOperator binary_op)
{
    ...
    ::std::for_each(policy3, make_zip_iterator(first1, scanned_tail_flags, mask, scanned_values, mask + 1),
                       ...
                       BinaryOperator binary_op)
{
    ...
    // is that some elements of result are written multiple times.
    {
        ...
        ::std::for_each(policy3, make_zip_iterator(first1, _mask.get() + 1, permute_it1),
...

    {
        ...
        ::std::for_each(policy4, make_zip_iterator(_scanned_values.get(), _mask.get() + 1, permute_it2),
