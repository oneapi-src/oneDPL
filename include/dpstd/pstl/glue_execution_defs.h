...
{
// Type trait
using dpstd::execution::is_execution_policy;
#if _PSTL_CPP14_VARIABLE_TEMPLATES_PRESENT
#    if __INTEL_COMPILER
template <class T>
constexpr bool is_execution_policy_v = is_execution_policy<T>::value;
#    else
using dpstd::execution::is_execution_policy_v;
#    endif
#endif
...
using dpstd::execution::sequenced_policy;
#if _PSTL_USE_PAR_POLICIES
using dpstd::execution::parallel_policy;
using dpstd::execution::parallel_unsequenced_policy;
#endif
// Standard predefined policy instances
using dpstd::execution::seq;
#if _PSTL_USE_PAR_POLICIES
using dpstd::execution::par;
using dpstd::execution::par_unseq;
#endif
// Implementation-defined names
// Unsequenced policy is not yet standard, but for consistency
// we include it into namespace std::execution as well
using dpstd::execution::unseq;
using dpstd::execution::unsequenced_policy;
} // namespace execution
} // namespace std
