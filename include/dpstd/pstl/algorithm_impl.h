...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, bool>
...
__brick_walk1(_DifferenceType __n, _Function __f, std::true_type) noexcept
{
    ...
    dpstd::__internal::__brick_walk1(__n, __f, std::false_type{});
}

template <class _ExecutionPolicy, class _ForwardIterator, class _Function, class _IsVector>
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, void>
...
#if _PSTL_USE_PAR_POLICIES
template <class _ExecutionPolicy, class _ForwardIterator, class _Function, class _IsVector>
dpstd::__internal::__enable_if_host_execution_policy_conditional<
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _ForwardIterator>
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _RandomAccessIterator>
__pattern_walk1_n(_ExecutionPolicy&& __exec, _RandomAccessIterator __first, _Size __n, _Function __f,
                  _IsVector __is_vector,
                  /*is_parallel=*/std::true_type)
{
    dpstd::__internal::__pattern_walk1(std::forward<_ExecutionPolicy>(__exec), __first, __first + __n, __f, __is_vector,
                                       std::true_type());
    return __first + __n;
}
#endif
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _ForwardIterator2>
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _RandomAccessIterator2>
...
template <class _ExecutionPolicy, class _ForwardIterator1, class _ForwardIterator2, class _ForwardIterator3,
          class _Function, class _IsVector>
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _ForwardIterator3>
...
template <class _ExecutionPolicy, class _ForwardIterator1, class _ForwardIterator2, class _BinaryPredicate,
          class _IsVector>
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _ForwardIterator1>
...
struct __brick_copy_n<_ExecutionPolicy, dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, void>>
{
...
template <typename _ExecutionPolicy>
struct __brick_copy<_ExecutionPolicy, dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, void>>
{
...
template <typename _ExecutionPolicy>
struct __brick_move<_ExecutionPolicy, dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, void>>
{
...
template <class _ExecutionPolicy, class _ForwardIterator, class _Predicate, class _IsVector>
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy,
                                                     typename std::iterator_traits<_ForwardIterator>::difference_type>
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, _BidirectionalIterator>
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, std::pair<_OutputIterator1, _OutputIterator2>>
...
struct __brick_fill<_Tp, _ExecutionPolicy, dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, void>>
{
    const _Tp& __value;
    ...
    return __parallel_set_union_op(
        ...
        [](_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator2 __last2,
           _T* __result, _Compare __comp) {
            return dpstd::__utils::__set_union_construct(__first1, __last1, __first2, __last2, __result, __comp,
                           ...
                           _Compare __comp, _IsVector __is_vector, /*is_parallel=*/std::true_type)
{
        ...
        return __internal::__parallel_set_op(
            ...
            [](_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2,
               _ForwardIterator2 __last2, _T* __result, _Compare __comp) {
                return dpstd::__utils::__set_intersection_construct(__first1, __last1, __first2, __last2, __result,
                                                                    __comp);
            },
            __is_vector);
    }
    ...
    if (__m2 > __set_algo_cut_off)
    {
        ...
        __result = __internal::__parallel_set_op(
            ...
            [](_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2,
               _ForwardIterator2 __last2, _T* __result, _Compare __comp) {
                return dpstd::__utils::__set_intersection_construct(__first2, __last2, __first1, __last1, __result,
                                                                    __comp);
            },
            __is_vector);
        return __result;
                         ...
                         _Compare __comp, _IsVector __is_vector, /*is_parallel=*/std::true_type)
{
    ...
    if (__n1 + __n2 > __set_algo_cut_off)
        return __parallel_set_op(std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __last2, __result,
                                 ...
                                 [](_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                                    _ForwardIterator2 __last2, _T* __result, _Compare __comp) {
                                     return dpstd::__utils::__set_difference_construct(
                                   ...
                                   _Compare __comp, _IsVector __is_vector, /*is_parallel=*/std::true_type)
{
    ...
    return __internal::__parallel_set_union_op(
        ...
        [](_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator2 __last2,
           _T* __result, _Compare __comp) {
            return dpstd::__utils::__set_symmetric_difference_construct(__first1, __last1, __first2, __last2, __result,
...
template <typename _ExecutionPolicy, typename _ForwardIterator, typename _Compare, typename _IsVector>
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, std::pair<_ForwardIterator, _ForwardIterator>>
...
dpstd::__internal::__enable_if_host_execution_policy<_ExecutionPolicy, std::pair<_ForwardIterator1, _ForwardIterator2>>
