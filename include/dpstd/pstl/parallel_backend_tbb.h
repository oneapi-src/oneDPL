...
#else
    tbb::detail::d1::task::current_execute_data()->context->cancel_group_execution();
#endif
}
...
class __task : public tbb::detail::d1::task
{
  protected:
    ...
    const tbb::detail::d1::execute_data* _M_execute_data{};
    __task* _M_parent{};
  ...
  public:
    ...
    {
        assert(_M_execute_data != nullptr);
        tbb::detail::d1::task::spawn(*__t, *_M_execute_data->context);
    }
    ...
    spawn_root_and_wait(__root_task<_Fn>& __root)
    {
        tbb::detail::d1::task::execute_and_wait(*__root._M_func_task, __root._M_context, __root._M_wait_object,
                                                __root._M_context);
    }
...
class __func_task : public __task
{
    ...
    __task*
    execute(const tbb::detail::d1::execute_data& __ed) override
    {
    ...
    __task*
    cancel(const tbb::detail::d1::execute_data& __ed) override
    {
...
class __root_task : public __task
{
    ...
    tbb::detail::d1::wait_object _M_wait_object{};
