...
void quickhull(const pointVec_t &points, pointVec_t &hull) {
    ...
    point_t p1 = *std::min_element(oneapi::dpl::execution::par_unseq, points.cbegin(), points.cend());
    point_t p2 = *std::max_element(oneapi::dpl::execution::par_unseq, points.cbegin(), points.cend());
#else
    auto minmaxx = std::minmax_element(oneapi::dpl::execution::par_unseq, points.cbegin(), points.cend());
    ...
    divide_and_conquer(oneapi::dpl::execution::par_unseq, points.cbegin(), points.cend(), hull, p1, p2, p1);
}
...
int main(int argc, char* argv[]) {
    ...
    std::generate(oneapi::dpl::execution::par, points.begin(), points.end(), util::random_point<double>);
