...
void applyGamma(Rows& image, double g) {
    ...
    //execution STL algorithms with execution policies - par and unseq
    ::std::for_each(oneapi::dpl::execution::par, image.begin(), image.end(), [g, w](Row& r) {
        ::std::transform(oneapi::dpl::execution::unseq, r, r+w, r, [g](Pixel& p) {
