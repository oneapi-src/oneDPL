...
class __future_with_tmps
{
  ...
  public:
    ...
    __future_with_tmps(_ExecPolicy __f, _Ts... __t)
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<
    Policy, oneapi::dpl::__internal::__future_promise_pair<Policy, OutputIter>>
...
// template<class _ExecutionPolicy, class _ForwardIterator, class T = typename
// std::iterator_traits<_ForwardIterator>::value_type>
// oneapi::dpl::__internal::__enable_if_async_execution_policy<_ExecutionPolicy,
// oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy, typename
// ::std::iterator_traits<_ForwardIterator>::value_type>> reduce(_ExecutionPolicy&& __exec, _ForwardIterator __first,
// _ForwardIterator __last);

template <class Policy, class InputIter, class UnaryFunction>
oneapi::dpl::__internal::__enable_if_async_execution_policy<Policy, oneapi::dpl::__par_backend_hetero::__future<Policy>>
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<
    Policy, oneapi::dpl::__internal::__future_promise_pair<Policy, ForwardIt2>>
transform(Policy&& policy, ForwardIt1 first1, ForwardIt1 last1, ForwardIt2 d_first, UnaryOperation unary_op);
