...
template<typename _ExecPolicy> using __future_with_tmps = oneapi::dpl::__internal::__future_with_tmps<_ExecPolicy>;
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<_ExecutionPolicy, __future_with_tmps<_ExecutionPolicy>>
__parallel_sort_impl_async(_ExecutionPolicy&& __exec, _Iterator __first, _Iterator __last, _Merge __merge, _Compare __comp)
{
    ...
    if (__n <= 1)
    {
        return __future_with_tmps<_ExecutionPolicy>(__exec);
    }
    ...
    return __future_with_tmps<_ExecutionPolicy>(__exec, __temp);
}
...
{
    __parallel_sort_impl_async(::std::forward<_ExecutionPolicy>(__exec), __first, __last,
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<_ExecutionPolicy, __future<_ExecutionPolicy>>
__parallel_for_async(_ExecutionPolicy&& __exec, _Fp __brick, _Index __count, _Ranges&&... __rngs)
{
    ...
    return __future<_Policy>(__exec);
}
...
__parallel_transform_reduce_async(_ExecutionPolicy&& __exec, _Up __u, _Cp __combine, _Rp __brick_reduce, _Ranges&&... __rngs)
{
    ...
    return ::oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_Tp>( __future<_ExecutionPolicy>{__exec}, __temp_1, __temp_2 /*__buf_1_ptr, __buf_2_ptr*/ );
}
...
oneapi::dpl::__internal::__future<_ExecutionPolicy>>
                ...
                /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    if (__n <= 0)
        return oneapi::dpl::__internal::__future<_ExecutionPolicy>(__exec);

    auto __keep =
        oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read_write, _ForwardIterator>();
    auto __buf = __keep(__first, __last);

    auto __future_obj = oneapi::dpl::__par_backend_hetero::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), unseq_backend::walk_n<_ExecutionPolicy, _Function>{__f}, __n, __buf.all_view());
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<_ExecutionPolicy,
    oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_ForwardIterator2>>
                ...
                _ForwardIterator2 __first2, _Function __f, /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    if (__n <= 0)
        return oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_ForwardIterator2>( __future<_ExecutionPolicy>{__exec}, __first2);
    ...
    return oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_ForwardIterator2>( __future_obj, __first2 + __n );
}
...
//_Tp>
oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_Tp>>
__pattern_transform_reduce_async(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last, _Tp __init,
                           _BinaryOperation __binary_op, _UnaryOperation __unary_op, /*vector=*/::std::true_type,
                           /*parallel=*/::std::true_type)
{
    //TODO: Empty sequence -> RETURN VALUE!
    //if (__first == __last)
    //    return ::oneapi::dpl::__internal::__make_future_promise_pair( ::oneapi::dpl::__internal::__future<_ExecutionPolicy>{__exec}, __init );//__init;
    ...
    return oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_Tp>( __res, __init, __binary_op );
...
oneapi::dpl::__internal::__enable_if_async_execution_policy<_ExecutionPolicy, oneapi::dpl::__internal::__future_promise_pair<_ExecutionPolicy,_ForwardIterator2>>
       ...
       _BinaryOperation __binary_op)
{
    ...
    //return oneapi::dpl::__internal::__make_future_promise_pair(::oneapi::dpl::__internal::__future<_ExecutionPolicy>{__exec}, ret_val);
    return ret_val;
}
