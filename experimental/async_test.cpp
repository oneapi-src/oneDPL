...
main()
{
    ...
    int a[N] = {0, 2, 4, 6, 8, 10, 12};
    {
        ...
        auto result =
            dpl::experimental::reduce_async(my_policy, dpl::begin(b), dpl::end(b), 1, std::plus<int>(), result1);
        ...
        auto result3 = dpl::experimental::sort_async(dpl::execution::make_device_policy<class sort2>(q), dpl::begin(b),
                                                     dpl::end(b), std::greater<int>(), result2);
