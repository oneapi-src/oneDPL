// -*- C++ -*-
//===-- exclusive_scan_by_segment_sycl.pass.cpp ------------------------------------===//
//
...
class ExclusiveScanBySegment {};     // name for policy
...
int main() {
...

    {
        ...
        auto new_policy = oneapi::dpl::execution::make_device_policy<ExclusiveScanBySegment>(oneapi::dpl::execution::dpcpp_default);
        // call algorithm
