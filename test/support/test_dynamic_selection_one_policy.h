...
class one_with_no_customizations {
  ...
  public:
    ...
    auto unwrap() { return 1; }
    one_with_no_customizations get_policy() { return p_; }
  };
  ...
  public:
    ...
    void wait() { trace_ = (trace_ | t_wait);}
    int unwrap() { return 1; }
  };
...
public:
  ...
  selection_type select(Args&&... args) {
...
class one_with_all_customizations {
  ...
  public:
    ...
    auto unwrap() { return 1; }
    one_with_all_customizations get_policy() { return p_; }
  };
...
public:
  ...
  // required
  template<typename Function, typename ...Args>
  auto submit(selection_type, Function&&, Args&&...) {
    trace_ = (trace_ | t_submit_selection); 
    return submission{trace_};
  }
  ...
  // optional
  template<typename Function, typename ...Args>
  void submit_and_wait(selection_type, Function&&, Args&&...) {
  ...
  // optional
  template<typename Function, typename ...Args>
  void submit_and_wait(Function&&, Args&&...) {
