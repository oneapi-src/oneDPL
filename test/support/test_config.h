...
#define _PSTL_TEST_COMPLEX_ACOS_BROKEN_IN_KERNEL                         (__INTEL_LLVM_COMPILER <= 20240200 && __SYCL_DEVICE_ONLY__ && __INTEL_LLVM_COMPILER < 20250100)
#define _PSTL_TEST_COMPLEX_EXP_BROKEN                                    (__INTEL_LLVM_COMPILER <= 20240200 && __SYCL_DEVICE_ONLY__ && __INTEL_LLVM_COMPILER < 20250100)
#define _PSTL_TEST_COMPLEX_TANH_BROKEN_IN_KERNEL                         (__INTEL_LLVM_COMPILER <= 20240200 && __SYCL_DEVICE_ONLY__ && __INTEL_LLVM_COMPILER < 20250100)
