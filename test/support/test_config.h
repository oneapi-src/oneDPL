...
#    define TEST_OF_COMPLEX_DIVIDE_EQUAL_BROKEN  0
#    define TEST_OF_COMPLEX_MINUS_EQUAL_BROKEN   0
#    define TEST_OF_COMPLEX_PLUS_EQUAL_BROKEN    0
#    define TEST_OF_COMPLEX_TIMES_EQUAL_BROKEN   0
#else
...
#    define TEST_OF_COMPLEX_PLUS_EQUAL_BROKEN    1
#    define TEST_OF_COMPLEX_TIMES_EQUAL_BROKEN   1
#endif
