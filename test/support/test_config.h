...
#define _PSTL_TEST_COMPLEX_ACOS_BROKEN_GLIBCXX                                                                         \
    (__SYCL_DEVICE_ONLY__ && __INTEL_LLVM_COMPILER && __GLIBCXX__ > 0 && __GLIBCXX__ <= 20210601)
...
#define _PSTL_TEST_COMPLEX_EXP_BROKEN_GLIBCXX                                                                         \
    (__SYCL_DEVICE_ONLY__ && __INTEL_LLVM_COMPILER && __GLIBCXX__ > 0 && __GLIBCXX__ <= 20210601)
...
#define _PSTL_TEST_COMPLEX_DIV_COMPLEX_BROKEN_GLIBCXX (__GLIBCXX__ > 0 && __GLIBCXX__ <= 20210601)
