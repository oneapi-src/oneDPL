...
// In MSVC C++20, _Can_deref concept returns wrong result for sycl_iterator, resulting in errors moving sycl_iterator
#define _PSTL_MSVC_GREATER_EQUAL_CPP20_CAN_DEREF_CONCEPT_BROKEN (_MSC_VER && __cplusplus >= 202002L && _MSVC_LANG >= 202002L)
