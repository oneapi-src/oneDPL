...
#define _PSTL_ICC_TEST_COMPLEX_NON_FLOAT_COMPLEX_DEPRECATED (_MSVC_STL_VERSION >= 143)
#define _PSTL_ICC_TEST_COMPLEX_ISINF_BROKEN (_MSC_VER && __INTEL_LLVM_COMPILER)
#define _PSTL_ICC_TEST_COMPLEX_ISNAN_BROKEN (_MSC_VER && __INTEL_LLVM_COMPILER)
