...
#define _PSTL_TEST_COMPLEX_ACOS_BROKEN_IN_KERNEL                         (0 < __INTEL_LLVM_COMPILER && __INTEL_LLVM_COMPILER < 20250100 && __SYCL_DEVICE_ONLY__)
#define _PSTL_TEST_COMPLEX_EXP_BROKEN_IN_KERNEL                          (0 < __INTEL_LLVM_COMPILER && __INTEL_LLVM_COMPILER < 20250100 && __SYCL_DEVICE_ONLY__)
#define _PSTL_TEST_COMPLEX_TANH_BROKEN_IN_KERNEL                         (0 < __INTEL_LLVM_COMPILER && __INTEL_LLVM_COMPILER < 20250100 && __SYCL_DEVICE_ONLY__)
