...
constexpr bool start_test()
{
    ...
    // int : <32, 64>
    using skip_dpwi_for_int = TestUtils::TList<DPWI<32>, DPWI<64>>;
    ...
    // float : <32, 64, 416, 512>
    // TODO required to implement case for Rsb: run-time issue with sycl::buffer only
    using skip_dpwi_for_float = TestUtils::TList<DPWI<32>, DPWI<64>, DPWI<416>, DPWI<512>>;
    ...
    // uint64_t, <64, 256, 288, 320, 352, 384, 416, 448, 480, 512>
    using skip_dpwi_for_uint64_t = TestUtils::TList<DPWI<64>, DPWI<256>, DPWI<288>, DPWI<320>, DPWI<352>, DPWI<384>, DPWI<416>, DPWI<448>, DPWI<480>, DPWI<512>>;
