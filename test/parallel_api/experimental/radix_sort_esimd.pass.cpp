...
struct test_general_cases_runner
{
    ...
    can_compile_test()
    {
        if constexpr (kind == GeneralCases::eRanges)
        {
            ...
            // char : <96, 160, 192, 224, 416, 448, 480>
            ...
            // int8_t : <448, 480>
            using skip_dpwi_for_int8_t = TestUtils::TList<DPWI<448>, DPWI<480>>;
            ...
            // uint8_t : <448, 480>
            using skip_dpwi_for_uint8_t = TestUtils::TList<DPWI<448>, DPWI<480>>;
            ...
            // int16_t : <480>
            using skip_dpwi_for_int16_t = TestUtils::TList<DPWI<480>>;
            ...
            // uint16_t : <448, 480>
            using skip_dpwi_for_uint16_t = TestUtils::TList<DPWI<448>, DPWI<480>>;
            ...
            // int64_t : <448, 480, 512>
            using skip_dpwi_for_int64_t = TestUtils::TList<DPWI<448>, DPWI<480>, DPWI<512>>;
            ...
            // uint64_t : <448, 480, 512>
            using skip_dpwi_for_uint64_t = TestUtils::TList<DPWI<448>, DPWI<480>, DPWI<512>>;
            ...
            // double : <480, 512>
            using skip_dpwi_for_double = TestUtils::TList<DPWI<480>, DPWI<512>>;
