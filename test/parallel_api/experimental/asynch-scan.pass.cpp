...
test_with_buffers(const int n)
{
    ...
    auto alpha = dpl::experimental::transform_inclusive_scan_async(
        my_policy1, dpl::begin(x), dpl::end(x), dpl::begin(y), std::plus<int>(), [](auto x) { return x * 10; });
    if (n > 0)
    {
    ...
    auto fut1b = dpl::experimental::transform_inclusive_scan_async(
        my_policy2, dpl::begin(x), dpl::end(x), dpl::begin(y), std::plus<int>(), [](auto x) { return x * 10; }, 1);
    if (n > 0)
    {
    ...
    auto beta = dpl::experimental::transform_exclusive_scan_async(my_policy3, dpl::begin(x), dpl::end(x), dpl::begin(y),
                                                                  0, std::plus<int>(), [](auto x) { return x * 10; });
    if (n > 0)
    {
    ...
    auto fut3b = dpl::experimental::inclusive_scan_async(my_policy5, dpl::begin(x), dpl::end(x), dpl::begin(y),
                                                         std::plus<int>(), gamma);
    if (n > 0)
    {
    ...
    auto fut3c = dpl::experimental::inclusive_scan_async(my_policy6, dpl::begin(x), dpl::end(x), dpl::begin(y),
                                                         std::plus<int>(), 1, fut3b);
    if (n > 0)
    {
    ...
    auto fut4b = dpl::experimental::exclusive_scan_async(my_policy8, dpl::begin(x), dpl::end(x), dpl::begin(y), 1,
                                                         std::plus<int>(), delta);
    if (n > 0)
    {
