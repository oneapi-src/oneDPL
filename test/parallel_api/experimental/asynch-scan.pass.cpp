...
test_with_buffers()
{
    const int n = 100;
    {
        ...
        auto my_policy = TEST_MAKE_DEVICE_POLICY(class Copy)(oneapi::dpl::execution::dpcpp_default);
        ...
        auto my_policy1 = TEST_MAKE_DEVICE_POLICY(class Scan1)(my_policy);
        ...
        auto my_policy2 = TEST_MAKE_DEVICE_POLICY(class Scan2)(my_policy);
        ...
        // transform exclusive
        auto my_policy3 = TEST_MAKE_DEVICE_POLICY(class Scan3)(my_policy);
        ...
        auto my_policy4 = TEST_MAKE_DEVICE_POLICY(class Scan4)(my_policy);
        ...
        auto my_policy5 = TEST_MAKE_DEVICE_POLICY(class Scan5)(my_policy);
        ...
        auto my_policy6 = TEST_MAKE_DEVICE_POLICY(class Scan6)(my_policy);
        ...
        auto my_policy7 = TEST_MAKE_DEVICE_POLICY(class Scan7)(my_policy);
        ...
        auto my_policy8 = TEST_MAKE_DEVICE_POLICY(class Scan8)(my_policy);
