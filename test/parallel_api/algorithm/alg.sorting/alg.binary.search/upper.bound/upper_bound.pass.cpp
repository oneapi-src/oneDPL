...
DEFINE_TEST(test_upper_bound)
{
               ...
               Iterator3 result_first, Iterator3 result_last, Size n)
    {
        ...
        auto res1 [[maybe_unused]] = oneapi::dpl::upper_bound(new_policy, first, last, value_first, value_last, result_first);
        ...
        auto res2 [[maybe_unused]] = oneapi::dpl::upper_bound(new_policy2, first, last, value_first, value_last, result_first,
               ...
               Iterator3 result_first, Iterator3 result_last, Size n)
    {
        ...
        // FIXME: add appropriate check for res1
        auto res1 [[maybe_unused]] = oneapi::dpl::upper_bound(exec, first, last, value_first, value_last, result_first);
        check_and_clean(result_first, value_first, n);

        // call algorithm with comparator
        // FIXME: add appropriate check for res2
        auto res2 [[maybe_unused]] = oneapi::dpl::upper_bound(exec, first, last, value_first, value_last, result_first,
                                             [](ValueT first, ValueT second) { return first < second; });
        check_and_clean(result_first, value_first, n);
    }
