...
main()
{
    ...
    test3buffers<sycl::usm::alloc::shared, std::uint64_t, test_lower_bound>();
    // Run tests for USM device memory
    test3buffers<sycl::usm::alloc::device, std::uint64_t, test_lower_bound>();
#endif
    test_algo_three_sequences<std::uint64_t, test_lower_bound>();
