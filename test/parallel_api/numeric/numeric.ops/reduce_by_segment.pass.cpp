...
#if defined(_ONEDPL_TEST_WORKAROUND_FOR_IGPU_64BIT_REDUCTION)
#    define ONEDPL_WORKAROUND_FOR_IGPU_64BIT_REDUCTION _ONEDPL_TEST_WORKAROUND_FOR_IGPU_64BIT_REDUCTION
#endif
