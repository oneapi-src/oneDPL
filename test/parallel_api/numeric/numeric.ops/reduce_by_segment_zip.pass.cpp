...
test_with_usm()
{
    ...
    SyclHelper::cpy_to_host(q, d_output_keys1_on_host,  d_output_keys1,  n);
    SyclHelper::cpy_to_host(q, d_output_keys2_on_host,  d_output_keys2,  n);
    SyclHelper::cpy_to_host(q, d_output_values_on_host, d_output_values, n);
