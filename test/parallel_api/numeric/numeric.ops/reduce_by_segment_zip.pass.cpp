...
test_with_usm()
{
    ...
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc1(q, std::begin(keys1),         std::end(keys1));
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc2(q, std::begin(keys2),         std::end(keys2));
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc3(q, std::begin(values),        std::end(values));
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc4(q, std::begin(output_keys1),  std::end(output_keys1));
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc5(q, std::begin(output_keys2),  std::end(output_keys2));
    TestUtils::sycl_usm_alloc<alloc_type, int> alloc6(q, std::begin(output_values), std::end(output_values));
