...
struct test_zip_iterator {
    ...
    void operator()(::std::vector<T1>& in1, ::std::vector<T2>& in2) {
        static_assert(::std::is_default_constructible<oneapi::dpl::zip_iterator<decltype(in1.begin()), decltype(in2.begin())>>::value,
        "Zip_iterator is not default constructible");
