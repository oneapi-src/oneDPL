...
int main(int argc, char** argv) {
    ...
    oneapi::dpl::permutation_iterator<iterator, iterator> p(src.begin(), n, map.begin());
    ...
    // Case 4 -- Linear traversal on accelerator
    {
        ...
        auto perm_begin = oneapi::dpl::make_permutation_iterator(src_begin, n, map_begin);
    ...
    // Case 5 -- Cyclic traversal on accelerator using function object for map indices
    {
        ...
        auto ref_end = oneapi::dpl::end(ref_buf);
        auto src_begin = oneapi::dpl::begin(src_buf);
        auto perm_begin = oneapi::dpl::make_permutation_iterator(src_begin, n, map);
