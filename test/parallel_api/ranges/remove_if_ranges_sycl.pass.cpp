...
main()
{
    ...
    EXPECT_TRUE(::std::distance(exp.begin(), exp_end) == in_end_n, "wrong return result from remove_if with sycl ranges");
    EXPECT_EQ_N(exp.begin(), in.begin(), in_end_n, "wrong effect from remove_if with sycl ranges");
