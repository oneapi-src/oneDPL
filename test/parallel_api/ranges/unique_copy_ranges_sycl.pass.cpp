...
main()
{
    ...
    EXPECT_EQ_RANGES(exam, views::host_all(A), "wrong effect from unique_copy, sycl ranges");
    EXPECT_EQ_RANGES(exam, views::host_all(B), "wrong effect from unique_copy with predicate, sycl ranges");
