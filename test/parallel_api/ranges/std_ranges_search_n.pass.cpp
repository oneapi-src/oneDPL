...
main()
{
    ...
    test_range_algo<0>{}(dpl_ranges::search_n,  std::ranges::search_n, 3, 5, binary_pred);
    test_range_algo<1>{}(dpl_ranges::search_n,  std::ranges::search_n, 3, 5, binary_pred, proj);
    test_range_algo<2, P2>{}(dpl_ranges::search_n,  std::ranges::search_n, 3, 5, binary_pred, &P2::x);
