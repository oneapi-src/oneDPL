...
main()
{
    ...
    test_range_algo<0, int, data_in_out_lim>{big_sizes_per_policy}(dpl_ranges::transform, transform_unary_checker, f);
    ...
    test_range_algo<4, int, data_in_in_out_lim>{big_sizes_per_policy}(dpl_ranges::transform, transform_binary_checker, binary_f);
