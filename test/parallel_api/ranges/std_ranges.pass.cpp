...
main()
{
    ...
    test_range_algo<1>{}(oneapi::dpl::ranges::any_of, std::ranges::any_of, pred, proj);
    test_range_algo<1>{}(oneapi::dpl::ranges::all_of, std::ranges::all_of, pred, proj);
    test_range_algo<1>{}(oneapi::dpl::ranges::none_of, std::ranges::none_of, pred, proj);
