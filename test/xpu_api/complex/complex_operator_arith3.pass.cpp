...
protected:
    ...
    void test_primary_form_1()
    {
        ...
        static_assert(::std::is_same<::std::decay<decltype(cv3.real())>::type, T>::value);
        static_assert(::std::is_same<::std::decay<decltype(cv3.imag())>::type, T>::value);
    ...
    void test_primary_form_2()
    {
        ...
        static_assert(::std::is_same<::std::decay<decltype(cv2.real())>::type, T>::value);
        static_assert(::std::is_same<::std::decay<decltype(cv2.imag())>::type, T>::value);
