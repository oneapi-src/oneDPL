...
protected:
    ...
    void test_fnc_real_form2_until_CPP14()
    {
        ...
        EXPECT_EQ_TYPE_EE(errors, typename TestUtils::Complex::InitConst<T>::DestComplexFieldType, real_res);
...
main()
{
    ...
    if (!TestUtils::Complex::test_on_host<TestComplexFncReal>())
        bSuccess = false;
    ...
    try
    {
        ...
        if (!TestUtils::Complex::test_in_kernel<TestComplexFncReal>(deviceQueue))
            bSuccess = false;
    }
