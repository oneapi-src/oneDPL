...
#ifndef _ONEDPL_RANDOM_INTERFACE_TESTS_DISTRS_COMMON_H
#define _ONEDPL_RANDOM_INTERFACE_TESTS_DISTRS_COMMON_H
...
#endif // _ONEDPL_RANDOM_INTERFACE_TESTS_DISTRS_COMMON_H
