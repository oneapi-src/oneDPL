...

    {
        ...
        deviceQueue.submit([&](sycl::handler& cgh) {
            ...
            cgh.single_task<class KernelTest1>([=]() {
                ...
                if (check_access[0])
                {
                    auto part1 = std::upper_bound(&access[0], &access[0] + N, X{2});
                    ret_access[0] = (part1 == &access[0] + N);
                    auto part2 = std::upper_bound(&access[0], &access[0] + N, X{2}, std::less<X>{});
                    ret_access[0] &= (part2 == &access[0] + N);

                    auto part3 = std::upper_bound(&access[0], &access[0] + N, X{9});
                    ret_access[0] &= (part3 != &access[0] + N);
                    ret_access[0] &= (part3->val == 6);
                    auto part4 = std::upper_bound(&access[0], &access[0] + N, X{9}, std::less<X>{});
                    ret_access[0] &= (part3 != &access[0] + N);
