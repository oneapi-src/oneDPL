    ...
    sycl::range<1> item1{1};
    {
        ...
        deviceQueue.submit([&](sycl::handler& cgh) {
            ...
            cgh.single_task<Iter>([=]() {
                ...
                for (int n = 0; n < 15; ++n)
                {
                    dpl::make_heap(work, work + n, dpl::greater<T>());
                    dpl::sort_heap(Iter(work), Iter(work + n), dpl::greater<T>());
                    ret_acc[0] &= dpl::is_sorted(work, work + n, dpl::greater<T>());
