    ...
    sycl::range<1> item1{1};
    {
        ...
        deviceQueue.submit([&](sycl::handler& cgh) {
            ...
            cgh.single_task<KernelName<Iter1, Iter2>>([=]() {
                ...
                int b[] = {0};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(b), Iter2(b + 1)) == Iter1(ia + sa - 1));
                int c[] = {0, 1};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(c), Iter2(c + 2)) == Iter1(ia + 18));
                int d[] = {0, 1, 2};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(d), Iter2(d + 3)) == Iter1(ia + 15));
                int e[] = {0, 1, 2, 3};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(e), Iter2(e + 4)) == Iter1(ia + 11));
                int f[] = {0, 1, 2, 3, 4};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(f), Iter2(f + 5)) == Iter1(ia + 6));
                int g[] = {0, 1, 2, 3, 4, 5};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(g), Iter2(g + 6)) == Iter1(ia));
                int h[] = {0, 1, 2, 3, 4, 5, 6};
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(h), Iter2(h + 7)) == Iter1(ia + sa));
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia + sa), Iter2(b), Iter2(b)) == Iter1(ia + sa));
                ret_acc[0] &= (find_end(Iter1(ia), Iter1(ia), Iter2(b), Iter2(b + 1)) == Iter1(ia));
            });
        });
    }
    assert(ret);
