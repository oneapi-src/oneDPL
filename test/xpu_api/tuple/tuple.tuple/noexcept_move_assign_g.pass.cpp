...
kernel_test1(sycl::queue& deviceQueue)
{
    deviceQueue.submit([&](sycl::handler& cgh) {
        cgh.single_task<class KernelTest1>([=]() {
            ...
            static_assert(dpl::is_nothrow_move_assignable<tt1>::value);
            static_assert(dpl::is_nothrow_move_assignable<tt2>::value);
            static_assert(dpl::is_nothrow_move_assignable<tt3>::value);
            static_assert(dpl::is_nothrow_move_assignable<tt4>::value);
            static_assert(dpl::is_nothrow_move_assignable<tt5>::value);
            static_assert(dpl::is_nothrow_move_assignable<tt6>::value);
        });
    });
}
