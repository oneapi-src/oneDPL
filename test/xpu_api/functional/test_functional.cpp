...
int main() {
    ...
    /* IDENTITY TEST: */
    {
        ...
        // create buffer
        SYCL_CL::sycl::buffer<T, 1> src_buf{SYCL_CL::sycl::range<1>(8)};
        SYCL_CL::sycl::buffer<T, 1> dst_buf{SYCL_CL::sycl::range<1>(8)};

        {
            auto data = src_buf.template get_access<SYCL_CL::sycl::access::mode::write>();
    ...
    /* MAXIMUM TEST: */
    {
        ...
        {   
            auto src = src_buf.template get_access<SYCL_CL::sycl::access::mode::write>();
            auto dst = dst_buf.template get_access<SYCL_CL::sycl::access::mode::write>();
        ...
        auto dst = dst_buf.template get_access<SYCL_CL::sycl::access::mode::read>();
