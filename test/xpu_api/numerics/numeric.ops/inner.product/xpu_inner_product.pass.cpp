...
test()
{
    ...
    int output[8] = {};
    SYCL_CL::sycl::range<1> numOfItems1{6};
    SYCL_CL::sycl::range<1> numOfItems2{8};

    {
        SYCL_CL::sycl::buffer<int, 1> buffer1(input1, numOfItems1);
        SYCL_CL::sycl::buffer<int, 1> buffer2(input2, numOfItems1);
        SYCL_CL::sycl::buffer<int, 1> buffer3(output, numOfItems2);
