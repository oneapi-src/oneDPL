...
test_device_copyable()
{
    ...
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::__par_backend_hetero::__gen_red_by_seg_input<noop_device_copyable>>,
        "__gen_red_by_seg_input is not device copyable with device copyable types");
