...
test_compile_time()
{
    constexpr std::tuple<int, int, std::uint64_t> std_tup1{1, 2, 3};
    constexpr std::tuple<int, std::uint32_t, int> std_tup2{99, 2, 3};
    constexpr oneapi::dpl::__internal::tuple<int, int, std::uint64_t> dpl_tup1{1, 2, 3};
    constexpr oneapi::dpl::__internal::tuple<int, std::uint32_t, int> dpl_tup2{99, 2, 3};
    ...
    constexpr oneapi::dpl::__internal::tuple<> dpl_empty1{};
    constexpr oneapi::dpl::__internal::tuple<> dpl_empty2{};
