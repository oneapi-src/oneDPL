...
test_by_type(Generator1 generator1, Generator2 generator2, Compare comp)
{
    ...
    {
        m = 0;
        invoke_on_all_policies(test_one_policy<T, 0>(), exp.begin(), exp.begin() + n, in1.begin(), in1.begin() + n, n,
                               m, generator1, generator2, comp);
        m = n / 7;
        invoke_on_all_policies(test_one_policy<T, 1>(), exp.begin(), exp.begin() + n, in1.begin(), in1.begin() + n, n,
                               m, generator1, generator2, comp);
        m = 3 * n / 5;
        invoke_on_all_policies(test_one_policy<T, 2>(), exp.begin(), exp.begin() + n, in1.begin(), in1.begin() + n, n,
                               m, generator1, generator2, comp);
    }
    invoke_on_all_policies(test_one_policy<T, 3>(), exp.begin(), exp.begin() + max_size, in1.begin(),
