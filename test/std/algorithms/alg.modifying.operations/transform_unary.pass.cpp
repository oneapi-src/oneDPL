...
template <typename T1, typename T2, bool Partition>
...
test()
{
    for (size_t n = 0; n <= 100000; n = n <= 16 ? n + 1 : size_t(3.1415 * n))
    {
        ...
        invoke_on_all_policies(test_one_policy<Tin, Tout, true>(), in.begin(), in.end(), out.begin(), out.end(), flip);
        invoke_on_all_policies(test_one_policy<Tin, Tout, false>(), in.cbegin(), in.cend(), out.begin(), out.end(),
                               flip);
    }
}
