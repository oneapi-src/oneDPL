...
ditaxml_topic_meta["description"]="For developers wanting to Get Started with the Intel® oneAPI DPC++ Library (oneDPL) Guide"
ditaxml_topic_meta["document title"]="Get Started with the Intel® oneAPI DPC++ Library (oneDPL) Guide"
...
ditaxml_topic_meta["shortDescription"]="Get Started Guide for users of the Intel® oneAPI DPC++ Library (oneDPL)."
ditaxml_topic_meta["shortTitle"]="Get Started with the Intel® oneAPI DPC++ Library (oneDPL) Guide"
...
ditaxml_prod_info["version"]="2021.5"

ditaxml_data_about={}
ditaxml_data_about["intelswd_aliasprefix"]={"datatype":"webAttr","value":"get-started-with-onedpl"}