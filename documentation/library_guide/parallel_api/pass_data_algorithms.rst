...
* The random access standard factories and adapters on top of the factories, random access containers, ``std::ranges::subrange``, and ``std::span`` on top of the host-side pointers and iterators.
